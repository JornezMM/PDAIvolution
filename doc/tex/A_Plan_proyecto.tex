...
\item Solución de errores vistos en la anterior review.
\item Conexión con la base de datos.
\end{enumerate}
\item \textbf{Periodo}
Este \textsl{sprint} se desarrolló entre 16 de febrero del 2024 y el 29 de febrero de 2024.
\item \textbf{\textsl{Review}}
Se cumplieron todos los objetivos del sprint. 
\end{itemize}
...
\item Creación de página de registro y funcionalidades.
\end{enumerate}
\item \textbf{Periodo}
Este \textsl{sprint} se desarrolló entre 1 de marzo del 2024 y el 14 de marzo de 2024.
\item \textbf{\textsl{Review}}
