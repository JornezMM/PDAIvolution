...
\subsection{Clasificación de los videos}
...
Para ilustrar la arquitectura de la aplicación se emplea el diagrama de despliegue de la figura~\ref{fig:./img/DiagramaDespliegue}. Este tipo de diagrama UML muestra cómo están organizados físicamente los componentes del software en el sistema.
...
\imagen{./img/DiagramaDespliegue}{Diagrama de despliegue}{}
