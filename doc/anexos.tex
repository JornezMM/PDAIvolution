...
\newcommand{\cp}[8]{
    ...
    \begin{table}[H]
    \begin{tabularx}{\textwidth}{L{0.3}L{0.6}}
    
    \toprule
	\textbf{Identificador}: CP\arabic{ncp} \\
    \rowcolor{gray!20}
	\textbf{Prioridad}: #1\\
	\textbf{Fecha de ejecución}: #2 \\
    \rowcolor{gray!20}
    \textbf{Realización}: #3 \\
    \textbf{Objetivo}: #4 \\
    \rowcolor{gray!20}
    \textbf{Precondiciones}: #6 \\
    ...
    \multicolumn{2}{@{}p{\textwidth}@{}}{
        ...
        \scriptsize
        \begin{tabularx}{\textwidth}{L{0.15\textwidth}L{0.25\textwidth}L{0.25\textwidth}L{0.25\textwidth}X}
            \rowcolor[gray]{.9}
...
% Datos de portada
\title{Clasificación del grado de Parkinson mediante aprendizaje supervisado \\Documentación Técnica}
